                ...
                <div class="container">
                    <div class="row justify-content-center align-items-center">
                        ...
                        <div class="col-lg-5 col-12 mb-5">
                            ...
                            <h2 class="text-white">Destech<br> Team sind bereit für Sie</h2>

                            <div class="d-flex align-items-center mt-5">
                                <a href="#topics-detail" class="text-white">Mehr lesen</a>
        ...
        <div class="footer-content">
            ...
            <div class="footer-social-links" class="icons"> 
                <a class="footer-social-link linkedin" href="https://www.linkedin.com/in/fatlind-destani-7002431a0/" target="_blank">
                    ...
                    <svg class="footer-social-icon-svg"  fill="currentColor" xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 30 30">
