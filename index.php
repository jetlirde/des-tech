                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-12 mx-auto">
                            <h1 class="text-white text-center">Welten verbinden mit Gebäudetechnik.</h1>

                            <h6 class="text-center">"Willkommen bei DesTech - Ihrem Spezialisten für Heizung, Lüftung und Sanitär im Kanton Bern. Mit modernen Technologien und einem engagierten Team bringen wir Behaglichkeit in Ihre Räume. 
                                Erfahren Sie, wie wir Tradition und Innovation verbinden, um Ihr Zuhause zu perfektionieren"
                                </h6>
                                    ...
                                    <div class="d-flex">
                                        <div>
                                            ...
                                            <p class="mb-0">
                                                ...
                                                <a href="pdf.pdf" style="color:#5818cd;">Sanitärinstallateur*in – 100% PDF "</a>
                                                <a href="pdf.pdf"style="color:#5818cd;">Heizungsinstallateur*in – 100% PDF</a>
                                                  
                                                <a href="pdf.pdf" style="color:#5818cd;">Lehrstelle Sanitärinstallateur– 100% PDFF</a><br>
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="custom-block custom-block-overlay">
                                <div class="d-flex flex-column h-100">
                                    <img src="images/foto1.jpeg" class="custom-block-image img-fluid" alt="">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-12 text-center" id="kontakt">
                            <h2 class="mb-4">Dienstleistungen</h1>
                        </div>
                ...
                <div class="container-fluid">
                    <div class="row justify-content-center">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="marketing-tab" data-bs-toggle="tab" data-bs-target="#marketing-tab-pane" type="button" role="tab" aria-controls="marketing-tab-pane" aria-selected="false">Lüftung</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                                ...
                                                <a class="d-flex flex-column justify-content-between h-100" href="topics-detail">
                                                    <div class="d-flex">
                                                        <div>
                                                            ...
                                                            <p class="mb-0">Heizung optimieren, Kosten senken, die Umwelt schonen. Mehr Energieeffizienz mit moderner Technik!</p>
                                                        </div>
                                                    ...
                                                    <div class="d-flex">
                                                        <div>
                                                            <h5 class="mb-2">Umbau/Sanierung</h5>
                                                                ...
                                                                <p class="mb-0">Heizung erneuern im Umbau oder bei Sanierung? 
                                                                    Entscheide dich für erneuerbare Energiequellen. Moderne Lösungen bieten Effizienz, Komfort und nachhaltige Wärme.
                                                                    </p>
                                                        </div>
                                                    ...
                                                    <div class="d-flex">
                                                        <div>
                                                            <h5 class="mb-2">Neubau</h5>
                                                                ...
                                                                <p class="mb-0">Heizungsanlage im Neubau? 
                                                                    Setzen Sie auf zukunftsorientierte Energie bei der Wärmeerzeugung aber auch auf nachhaltige Wärmeabgabe.
                                                                    </p>
                                                        </div>
