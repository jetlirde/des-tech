                        ...
                        <div class="col-lg-5 col-12">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Sanitär</li>
                                </ol>
                            </nav>

                            <h2 class="text-white">Sanitär</h2>
                        </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-12 text-center">
                            <h3 class="mb-4">Zuverlässige Wärme, zu jeder Zeit</h3>
                        </div>

                        <div class="col-lg-8 col-12 mt-3 mx-auto">
                            <div class="custom-block custom-block-topics-listing bg-white shadow-lg mb-5">
                                <div class="d-flex">
                                    <img src="images/topics/sanitarr.jpg" class="custom-block-image img-fluid" alt="">

                                    <div class="custom-block-topics-listing-info d-flex">
                                        <div>
                                            <h5 class="mb-2">Individuelle Planung und Beratung </h5>

                                            <p class="mb-0">Wir beraten Sie basierend auf einer individuellen Bedarfsanalyse 
                                                Sie erhalten eine ausführliche Beratung zu Brennstoffen und Fördermitteln 
                                                Nach Vertragsabschluss erstellen wir eine transparente und bindende Kostenaufstellung </p>
                            ...
                            <div class="custom-block custom-block-topics-listing bg-white shadow-lg mb-5">
                                <div class="d-flex">
                                    <img src="images/topics/san.jpeg" class="custom-block-image img-fluid" alt="">

                                    <div class="custom-block-topics-listing-info d-flex">
                                        <div>
                                            <h5 class="mb-2">Qualität vom Fachmann  </h5>

                                            <p class="mb-0">Wir verbauen ausschliesslich Markenprodukte führender Hersteller
                                                Sie profitieren von umfassenden Service- und Garantieleistungen 
                                                Wir kümmern uns um einen regelmässigen Service und Wartung </p>
                            ...
                            <div class="custom-block custom-block-topics-listing bg-white shadow-lg mb-5">
                                <div class="d-flex">
                                    <img src="images/topics/sanitaryy.jpg" class="custom-block-image img-fluid" alt="">

                                    <div class="custom-block-topics-listing-info d-flex">
                                        <div>
                                            <h5 class="mb-2">Professionelle Installation </h5>
